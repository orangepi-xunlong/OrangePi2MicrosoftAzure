...
#define INPUT_PLUGIN_NAME "CSI webcam grabber"
...
int input_init(input_parameter *param, int id)
{
    ...
    IPRINT("Format............: %s\n", (format == V4L2_PIX_FMT_YUV420) ? "YUV" : "MJPEG");
    if(format == V4L2_PIX_FMT_YUV420)
        IPRINT("JPEG Quality......: %d\n", gquality);

    DBG("vdIn pn: %d\n", id);
    /* open video device and prepare data structure */
    if(OrangePi_VideoIn(cams[id].videoIn, dev, width, height, fps, 1, cams[id].pglobal, id) < 0) {
